...
- Using Metasploit in Kali Linux to create our own virus [Trojan malware]
  - Learning how to create a reverse TCP Trojan executable containing Meterpreter
  - Learning how Trojan malware can steal screenshots, keystrokes, and spy on victims through webcam
- Learning how to create a web sharable and executable folder to hack from a Kali Linux VM into a Windows VM
