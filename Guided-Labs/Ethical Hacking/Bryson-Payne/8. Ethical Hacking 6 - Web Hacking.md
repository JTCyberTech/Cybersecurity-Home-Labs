...
5. When we repeat steps 2 and 3 on the Chrome browser, then on step 4:
    - On the DVWA page on Chrome click on > XSS stored > Type: john; message: <script>alert("You have been hacked!");</script>
...
6. Go to my own local machine and repeat steps 2 and 3
    ...
    - Instead of typing in message: <script>alert("You have been hacked!");</script>
      - We will type: <script>window.location="http://ge.com"</script>
