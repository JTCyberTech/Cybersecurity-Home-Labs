...
2. On Server Manager > Click on "Manage" > "Add Roles and Features"

![image](https://github.com/user-attachments/assets/a1919a49-cc18-4340-bb7f-badbfde15827)

3. Next on "Before You Begin" > Next on "Installation Type" > Next on "Server Selection" > Check the box for `DHCP Server` on "Server Roles" -> "Add Features" and Next > Next on "Features" > Next on "DHCP Server" > Install on "Confirmation".
