...
I recommend using [hostinger](https://www.hostinger.com/) and using their web hosting plan for a year. It will provide you a domain for free that is included in their web hosting plan, you can showcase your project on the project at the same time. This is my domain: [https://jeffcybercheck.tech/](https://jeffcybercheck.tech/).
